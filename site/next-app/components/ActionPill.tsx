  ...
  return (
    <Button
      ...
      className={cn(
        ...
        (variant === 'download' || variant === 'retry') && 'flex-none',
        // Open hugs the far-right edge of the action bar — `ml-auto` inside a
        // flex row pushes it against the end, keeping Copy + Download grouped
        // on the left at their natural widths.
        variant === 'open' && 'flex-none ml-auto',
